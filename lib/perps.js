...
async function fetchPerpsLiveRates(opts = {}) {
  ...
  const [hlRates, nadoRates, grvtRates, extendedRates, variationalRates, phoenixRates, lighterRates] = await Promise.all([
...
async function fetchPerpsDashboard(wallets, opts = {}) {
  ...
  const [grvtRates, extendedRates, variationalRates, phoenixRates, perplRates, lighterRates] = await Promise.all([
    grvtEnabled
